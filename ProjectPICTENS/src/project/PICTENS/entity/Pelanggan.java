 ...
 */
package project.PICTENS.entity;
...
public class Pelanggan {
    ...
    public Pelanggan(String nama, String expertise, String alamat, String telepon, String email) {
        this.nama = nama;
    ...
    public int hashCode() {
        ...
        hash = 97 * hash + Objects.hashCode(this.expertise);
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.expertise, other.expertise)) {
            return false;
        }
